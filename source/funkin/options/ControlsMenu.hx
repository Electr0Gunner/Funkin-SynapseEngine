...
import funkin.gameplay.PlayerSettings;
import funkin.gameplay.Controls;
...
import funkin.options.AtlasText;
import funkin.options.MenuList;
import funkin.options.TextMenuList;

class ControlsMenu extends funkin.options.OptionsState.Page
{
